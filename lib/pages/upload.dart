...
class _UploadState extends State<Upload> {
  ...
  handleTakePhoto() async {
    ...
    if (file != null) {
      setState(() {
        this.file = file;
        ShowImage showImage = ShowImage(file);
      ...
      child: Column(
        ...
        children: <Widget>[
                        ...
                        onPressed: () {
                          setState(() {
                            if (file != null && postFiles.length > 0) {
                              setState(() {
                                goToAddDailyWorker = true;
                              });
                            } else {
                              Scaffold.of(context).showSnackBar(new SnackBar(
                                  content:
                                      new Text('You need to upload a photo')));
                            }
                          });
                        },
                      ),
          ...
          SingleChildScrollView(
              ...
              child: Row(children: showImageList))
        ],
      ),
    );
  }
  ...
  Future<String> uploadImage(imageFile, i) async {
    StorageUploadTask uploadTask =
        storageRef.child('post_$postid' + '_' + '$i.jpg').putFile(imageFile);
  ...
  createPostInFirebase(
      {List<String> mediaUrl, String location, String description}) {
    postsRef
  ...
  createDailyWorkerInFirebase(
      ...
      String wageforday,
      String location}) {
    dailyworkersRef.document(dailyworkerid).setData({
  ...
  handleDailyWorkerSubmit() async {
    ...
    if (locationController.text.isNotEmpty &&
      ...
      createDailyWorkerInFirebase(
          ...
          anotherphone: anotherphoneController.text.isNotEmpty
              ? anothercountryCode + anotherphoneController.text
              : "",
      ...
      Scaffold.of(context).showSnackBar(
          new SnackBar(content: new Text('You need to fill out all fields')));
    }
  }
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          hintText: "Wage for hour", border: InputBorder.none),
                      keyboardType: TextInputType.number,
                    ),
                  ),
                  SizedBox(
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          hintText: "Wage for day", border: InputBorder.none),
                      keyboardType: TextInputType.number,
                    ),
                  ),
                ],
